...
impl SingleThreadedMutexedWriter {
    /// Creates a new MutexedWriter implementation for SingleThreaded Environments
    ///
    /// # Safety: It is unsafe to use this type in any context that is not strictly single-threaded.
    pub unsafe fn new(uart: Pl011) -> Self {
